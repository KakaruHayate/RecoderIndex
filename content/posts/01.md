...
---
 ...
 - **2022年9月26日更新**
 - **删除了位于海外的用于与CDN交互的API，支持HLS流的直播间可以继续正常录制到HLS了**
 - **cpolar在过期之前将用于alist的测试，支持多盘挂载，支持弹幕播放，欢迎使用**
...
## 提取链接 ##
 ...
 - **alist测试站 链接①（推荐）：https://kakarurec.cpolar.cn/ 链接②：https://alist.kakaru.live/ **
